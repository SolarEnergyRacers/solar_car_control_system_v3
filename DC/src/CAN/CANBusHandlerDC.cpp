...
void CANBus::handle_rx_packet(CANPacket packet) {
  ...
  case AC_BASE_ADDR | 0x00:
    ...
    carState.Kp = packet.getData_u8(2) / 100.;
    carState.Ki = packet.getData_u8(3) / 100.;
    carState.Kd = packet.getData_u8(4) / 100.;
    carState.ConstantMode = packet.getData_b(33) ? CONSTANT_MODE::SPEED : CONSTANT_MODE::POWER;
